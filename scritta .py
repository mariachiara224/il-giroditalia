...
messagee = Text(Point(500,400), "energia=")
messagee.draw(win)
message = Text(Point(1500,400), "energia")
messagee2 = Text(Point(500,370), "potenza=")
messagee2.draw(win)
message2 = Text(Point(1500,370), "potenza")
...
while x<6500 :
    ...
    print ("sinalfa=",sinalfa,"potenza=",p,"energia residua=",er,"x=",x,"velocità=",v,"dt=",dt)
